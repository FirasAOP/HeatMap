/**
 * X axis component package.
 * @module src/views/nt/XAxiss/XAxis
 */
...
export const HgXAxis = (props) => {
  ...
  return (
    <div
      style={{ height: props.height + "px", marginBottom: "2dvh" }}
      className={
        "x-axis " + (direction === "rtl" ? "y-axis-right" : "y-axis-left")
      }
    >
